...
#ifndef ASB_REGULATED_PURE_PURSUIT_CONTROLLER__COLLISION_CHECKER_HPP_
#define ASB_REGULATED_PURE_PURSUIT_CONTROLLER__COLLISION_CHECKER_HPP_
...
/**
 * @class asb_regulated_pure_pursuit_controller::CollisionChecker
...
public:
  /**
   * @brief Constructor for asb_regulated_pure_pursuit_controller::CollisionChecker
   */
  CollisionChecker(
...
#endif  // ASB_REGULATED_PURE_PURSUIT_CONTROLLER__COLLISION_CHECKER_HPP_
