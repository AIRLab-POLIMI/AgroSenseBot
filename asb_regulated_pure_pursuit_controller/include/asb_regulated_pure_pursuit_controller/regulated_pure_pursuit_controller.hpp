...
protected:
     ...
     */
    std::unique_ptr<geometry_msgs::msg::PolygonStamped> createLookAheadCircleMsg(const double &lookahead_dist, const builtin_interfaces::msg::Time &stamp);
    ...
    std::shared_ptr<rclcpp_lifecycle::LifecyclePublisher<geometry_msgs::msg::PoseArray>> cost_gradient_descent_poses_pub_;
