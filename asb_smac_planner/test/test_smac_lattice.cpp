...
#include "asb_smac_planner/smac_planner_lattice.hpp"
...
class LatticeWrap : public asb_smac_planner::SmacPlannerLattice
{
public:
...
TEST(SmacTest, test_smac_lattice)
{
  ...
  auto planner = std::make_unique<asb_smac_planner::SmacPlannerLattice>();
  try {
