...
#include "asb_smac_planner/upsampler_cost_function.hpp"
#include "asb_smac_planner/upsampler_cost_function_nlls.hpp"
...
/**
 * @class asb_smac_planner::Upsampler
...
public:
  /**
   * @brief A constructor for asb_smac_planner::Upsampler
   */
  Upsampler() {}

  /**
   * @brief A destructor for asb_smac_planner::Upsampler
   */
  ~Upsampler() {}
