...
#include "asb_smac_planner/options.hpp"
...
/**
 * @struct asb_smac_planner::UnconstrainedSmootherCostFunction
...
public:
  /**
   * @brief A constructor for asb_smac_planner::UnconstrainedSmootherCostFunction
  ...
  {
    /**
     * @brief A constructor for asb_smac_planner::CurvatureComputations
     */
