...
#include "asb_smac_planner/constants.hpp"
#include "asb_smac_planner/types.hpp"
#include "asb_smac_planner/collision_checker.hpp"
#include "asb_smac_planner/costmap_downsampler.hpp"
...
/**
 * @struct asb_smac_planner::HybridMotionTable
 * @brief A table of motion primitives and related functions
 */
struct HybridMotionTable
{
  /**
   * @brief A constructor for asb_smac_planner::HybridMotionTable
   */
  HybridMotionTable() {}
...
/**
 * @class asb_smac_planner::NodeHybrid
...
public:
  ...
  /**
   * @class asb_smac_planner::NodeHybrid::Coordinates
   * @brief NodeHybrid implementation of coordinate structure
   */
  struct Coordinates
  {
    /**
     * @brief A constructor for asb_smac_planner::NodeHybrid::Coordinates
     */
    Coordinates() {}
  ...
  /**
   * @brief A constructor for asb_smac_planner::NodeHybrid
   * @param index The index of this node for self-reference
   */
  explicit NodeHybrid(const unsigned int index);

  /**
   * @brief A destructor for asb_smac_planner::NodeHybrid
   */
  ~NodeHybrid();
  ...
  /**
   * @brief Get pose of node
   * @return Coordinates pose
   */
  inline void getPose(float& x, float& y)
  {
      x = pose.x;
      y = pose.y;
  }
   ...
   */
  void getNeighbors(
    std::function<bool(const unsigned int &, asb_smac_planner::NodeHybrid * &)> & validity_checker,
