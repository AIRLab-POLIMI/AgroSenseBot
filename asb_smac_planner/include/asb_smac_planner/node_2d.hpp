...
public:
  ...
  /**
   * @class asb_smac_planner::Node2D::Coordinates
  ...
  /**
   * @brief A constructor for asb_smac_planner::Node2D
   * @param index The index of this node for self-reference
   */
  explicit Node2D(const unsigned int index);

  /**
   * @brief A destructor for asb_smac_planner::Node2D
   */
  ~Node2D();
   ...
   */
  void getNeighbors(
    std::function<bool(const unsigned int &, asb_smac_planner::Node2D * &)> & validity_checker,
