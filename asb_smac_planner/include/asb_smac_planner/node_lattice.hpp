...
#include "asb_smac_planner/utils.hpp"
...
/**
 * @struct asb_smac_planner::LatticeMotionTable
 * @brief A table of motion primitives and related functions
 */
struct LatticeMotionTable
{
  /**
   * @brief A constructor for asb_smac_planner::LatticeMotionTable
   */
  LatticeMotionTable() {}
...
/**
 * @class asb_smac_planner::NodeLattice
...
public:
  ...
  /**
   * @brief A constructor for asb_smac_planner::NodeLattice
   * @param index The index of this node for self-reference
   */
  explicit NodeLattice(const unsigned int index);

  /**
   * @brief A destructor for asb_smac_planner::NodeLattice
   */
  ~NodeLattice();
  ...
  void getNeighbors(
    ...
    asb_smac_planner::NodeLattice * &)> & validity_checker,
    GridCollisionChecker * collision_checker,
    const bool & traverse_unknown,
