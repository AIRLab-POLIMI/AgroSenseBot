...
/**
 * @class asb_smac_planner::PathSegment
...
/**
 * @struct asb_smac_planner::BoundaryPoints
...
/**
 * @struct asb_smac_planner::BoundaryExpansion
...
/**
 * @class asb_smac_planner::Smoother
...
public:
  /**
   * @brief A constructor for asb_smac_planner::Smoother
   */
  explicit Smoother(const SmootherParams & params);

  /**
   * @brief A destructor for asb_smac_planner::Smoother
   */
  ~Smoother() {}
