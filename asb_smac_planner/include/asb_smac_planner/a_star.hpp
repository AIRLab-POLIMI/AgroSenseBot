...
#include "asb_smac_planner/thirdparty/robin_hood.h"
...
#include "asb_smac_planner/node_basic.hpp"
...
/**
 * @class asb_smac_planner::AStarAlgorithm
...
public:
  ...
  /**
   * @struct asb_smac_planner::NodeComparator
  ...
  bool createPath(
    ...
    std::vector<std::tuple<float, float, float, float, float, bool>> * expansions_log = nullptr);
