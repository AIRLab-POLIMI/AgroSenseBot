...
/**
 * @struct asb_smac_planner::SearchInfo
...
/**
 * @struct asb_smac_planner::SmootherParams
 * @brief Parameters for the smoother
 */
struct SmootherParams
{
  /**
   * @brief A constructor for asb_smac_planner::SmootherParams
   */
  SmootherParams()
  : holonomic_(false)
  {
...
/**
 * @struct asb_smac_planner::MotionPose
 * @brief A struct for poses in motion primitives
 */
struct MotionPose
{
  /**
   * @brief A constructor for asb_smac_planner::MotionPose
   */
  MotionPose() {}
...
/**
 * @struct asb_smac_planner::LatticeMetadata
...
/**
 * @struct asb_smac_planner::MotionPrimitive
