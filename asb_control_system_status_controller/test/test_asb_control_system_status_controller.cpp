...
class TestableASBControlSystemStatusController : public asb_control_system_status_controller::ASBControlSystemStatusController
{
public:
  using ASBControlSystemStatusController::ASBControlSystemStatusController;
  std::shared_ptr<geometry_msgs::msg::TwistStamped> getLastReceivedTwist()
  {
    std::shared_ptr<geometry_msgs::msg::TwistStamped> ret;
    received_heartbeat_msg_ptr_.get(ret);
    return ret;
  }
    ...
    const std::chrono::milliseconds & timeout = std::chrono::milliseconds(500))
  {
    ...
    wait_set.add_subscription(heartbeat_subscriber_);
...
class TestASBControlSystemStatusController : public ::testing::Test
{
protected:
  ...
  void SetUp() override
  {
    controller_ = std::make_unique<TestableASBControlSystemStatusController>();
  ...
  const std::string controller_name = "test_asb_control_system_status_controller";
  std::unique_ptr<TestableASBControlSystemStatusController> controller_;
...
TEST_F(TestASBControlSystemStatusController, configure_fails_without_parameters)
{
...
TEST_F(TestASBControlSystemStatusController, configure_fails_with_only_left_or_only_right_side_defined)
{
  const auto ret = controller_->init(controller_name);
  ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestASBControlSystemStatusController, configure_fails_with_mismatching_wheel_side_size)
{
  const auto ret = controller_->init(controller_name);
  ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestASBControlSystemStatusController, configure_succeeds_when_wheels_are_specified)
{
  const auto ret = controller_->init(controller_name);
  ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestASBControlSystemStatusController, activate_fails_without_resources_assigned)
{
  const auto ret = controller_->init(controller_name);
  ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestASBControlSystemStatusController, activate_succeeds_with_pos_resources_assigned)
{
  const auto ret = controller_->init(controller_name);
  ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestASBControlSystemStatusController, activate_succeeds_with_vel_resources_assigned)
{
  const auto ret = controller_->init(controller_name);
  ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestASBControlSystemStatusController, activate_fails_with_wrong_resources_assigned_1)
{
  const auto ret = controller_->init(controller_name);
  ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestASBControlSystemStatusController, activate_fails_with_wrong_resources_assigned_2)
{
  const auto ret = controller_->init(controller_name);
  ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestASBControlSystemStatusController, cleanup)
{
  const auto ret = controller_->init(controller_name);
  ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestASBControlSystemStatusController, correct_initialization_using_parameters)
{
  const auto ret = controller_->init(controller_name);
  ASSERT_EQ(ret, controller_interface::return_type::OK);
