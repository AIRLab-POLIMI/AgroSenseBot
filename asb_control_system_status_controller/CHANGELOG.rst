...
2.20.0 (2023-05-14)
-------------------
* Clear registered handles of ASBControlSystemStatusController on deactivate (`#596 <https://github.com/ros-controls/ros2_controllers/issues/596>`_) (`#606 <https://github.com/ros-controls/ros2_controllers/issues/606>`_)
...
2.17.1 (2023-02-20)
-------------------
* [ASBControlSystemStatusController] Fix prefixing of frame id with controller's namespace (`#522 <https://github.com/ros-controls/ros2_controllers/issues/522>`_)
...
2.15.0 (2022-12-06)
-------------------
* [ASBControlSystemStatusController] Use generate parameter library (`#386 <https://github.com/ros-controls/ros2_controllers/issues/386>`_)
* [ASBControlSystemStatusController] Change units of velocity feedback (`#452 <https://github.com/ros-controls/ros2_controllers/issues/452>`_)
