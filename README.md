...
and [install Webots](https://cyberbotics.com/doc/guide/installing-webots) (must use the version [2023b](https://github.com/cyberbotics/webots/releases/tag/R2023b)), then run these commands:
...
pip install cobs &&  # used to decode serial data from arduino
mkdir -p ~/asb_logs/ &&
