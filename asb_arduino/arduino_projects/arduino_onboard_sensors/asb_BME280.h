...
#ifndef _ASB_BME280_H_
#define _ASB_BME280_H_
...
public:
  ...
  float last_temperature, last_pressure, last_humidity;

  uint32_t burst_transmission_micros, burst_response_micros, burst_read_micros;

private:
  int _devAddr;
  bool isTransport_OK;

  int32_t last_adc_P, last_adc_T, last_adc_H;
