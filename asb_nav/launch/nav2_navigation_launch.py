...
def generate_launch_description():
    ...
    controller_configured_params = ParameterFile(
        RewrittenYaml(
    ...
    planner_configured_params = ParameterFile(
        RewrittenYaml(
    ...
    declare_map_server_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value="",
        description='Full path to the ROS2 parameters file to use for the map server')
    ...
    load_nodes = GroupAction(
        ...
        actions=[
            ...
            Node(
                ...
                respawn=use_respawn,
                respawn_delay=2.0,
                parameters=[controller_configured_params, configured_params],
            ...
            Node(
                ...
                respawn=use_respawn,
                respawn_delay=2.0,
                parameters=[planner_configured_params, configured_params],
                arguments=['--ros-args', '--log-level', log_level],
                remappings=remappings),
            Node(
    ...
    ld.add_action(declare_map_server_params_file_cmd)
