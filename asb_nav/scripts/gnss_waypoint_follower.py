...
class YamlWaypointParser:
    ...
    def get_wps(self):
        ...
        for wp in self.wps_dict["waypoints"]:
            ...
            geo_pose_wps.append(latLonYaw2Geopose(latitude, longitude, yaw))
        return geo_pose_wps
...
def main():
    ...
    default_yaml_file_path = os.path.join(get_package_share_directory("asb_nav"), "config", "gnss_waypoints", "gnss_waypoints.yaml")
    if len(sys.argv) > 1:
